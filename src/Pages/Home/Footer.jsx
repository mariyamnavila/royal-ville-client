                ...
                <div className="grid grid-cols-1 md:grid-cols-6  gap-7 border-y border-[#25262a]">
                    ...
                    <div className="md:col-span-1 col-span-3 text-white pt-10 ml-4 pb-16">
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="text-white hover:text-[#D6A23F] hover:link transition duration-500 ease-in-out">Top Hotel Room</p>
                            <p className="text-white hover:text-[#D6A23F] hover:link transition duration-500 ease-in-out">Quick Links</p>
                            <p className="text-white hover:text-[#D6A23F] hover:link transition duration-500 ease-in-out">Important Links</p>
                            <p className="text-white hover:text-[#D6A23F] hover:link transition duration-500 ease-in-out">Insights</p>
                    ...
                    <div className="md:col-span-1 col-span-3 text-white pt-10 ml-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="text-white hover:text-[#D6A23F] hover:link transition duration-500 ease-in-out">FAQ Page</p>
                            <p className="text-white hover:text-[#D6A23F] hover:link transition duration-500 ease-in-out">Get in Touch</p>
                            <p className="text-white hover:text-[#D6A23F] hover:link transition duration-500 ease-in-out">Global Network</p>
                    ...
                    <div className="md:col-span-1 col-span-3 text-white pt-10 ml-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="text-white hover:text-[#D6A23F] hover:link transition duration-500 ease-in-out">Our Services</p>
                            <p className="text-white hover:text-[#D6A23F] hover:link transition duration-500 ease-in-out">What We Do</p>
                            <p className="text-white hover:text-[#D6A23F] hover:link transition duration-500 ease-in-out">Abandonment Cart</p>
                            <p className="text-white hover:text-[#D6A23F] hover:link transition duration-500 ease-in-out">Shipments</p>
                            <p className="text-white hover:text-[#D6A23F] hover:link transition duration-500 ease-in-out">Pricing Flexibility</p>
                        </div>
                    </div>
                </div>
                <div>
                    <footer className="footer sm:footer-horizontal text-neutral-content items-center p-4">
                        ...
                        <div className="flex text-2xl gap-7">
                            ...
                            <CiTwitter className='text-white hover:text-[#D6A23F] hover:link transition duration-500 ease-in-out '/>
                            <CiInstagram className='text-white hover:text-[#D6A23F] hover:link transition duration-500 ease-in-out '/>
                            <FaYoutube className='text-white hover:text-[#D6A23F] hover:link transition duration-500 ease-in-out '/>
                            <FaDribbble className='text-white hover:text-[#D6A23F] hover:link transition duration-500 ease-in-out '/>
                        </div>
