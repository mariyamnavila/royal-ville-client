        ...
        <div className="bg-[url('./assets/banner.jpg')] bg-center">
            <div className="bg-linear-to-b from-black to-[#0000008e]">
                <div className="pt-[200px] pb-[260px] max-w-7xl mx-auto">
                    ...
                    <h2 className="text-white text-7xl elegant my-9">Comfort Awaits <br /> Reserve Your Room Now</h2>
                    <button className="btn relative overflow-hidden group bg-[#D6A23F] border border-[#D6A23F] text-black mr-3 py-7 px-7">
                        <span className="absolute inset-0 bg-[#FAF7F2] transform scale-y-0 transition-transform duration-300 ease-out origin-center rotate-120 group-hover:scale-y-300 "></span>
