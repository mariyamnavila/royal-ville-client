...
const Service = () => {
    return (
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center mt-20 border-b border-gray-300 space-y-6">
            ...
            <div className="bg-primary rounded-full flex flex-col items-center justify-center w-[260px] h-[250px] mx-auto lg:mr-7 space-y-2">
                <p className="text-2xl font-medium">Sophie Graham</p>
                <p className="text-xs text-gray-600">Chief Sustainability Officer</p>
            </div>
        </div>
    );
};
